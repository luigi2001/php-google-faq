...
$faq = [
    ...
    [
        ...
        2. La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali. <br> <br>
    ...
    <header>
        ...
        <div class="header-bottom">
            <ul>
                ...
                <li>Tecnologie</li>
                <li class="special">Domande frequenti</li>
            </ul>
        </div>
    </header>
    <main>
        <?php foreach($faq as $text){ ?>
           <h3> <?php echo $text['domanda'] ?> </h3>
